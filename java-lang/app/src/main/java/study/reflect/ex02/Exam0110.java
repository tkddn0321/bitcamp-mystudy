...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(clazz2.getTypeName()); // com.eomcs.reflect.ex02.Exam01com.eomcs.reflect.ex02.Exam01$A$A

    System.out.println("------------------------------------------");

    //3) 익명 클래스
    Class<?> clazz 6f21`q   3 = obj.getClass(); // 익명 클래스의 인스턴스로부터 클래스 정보 추출
