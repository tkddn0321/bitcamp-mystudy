...
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTSdtDateImpl;
...
public class Prompt {
  ...
  // 각 클라이언트가 접속하는 동안 사용할 수 있는 값의 보관소
  ...
  private PrintWriter printWriter = new PrintWriter(strWriter); // StringWriter에 문자열을 다양한 형식으로 출력할 수 있도록 도와주는 데코레이터

  // 문자열을 다양한 형식으로 출력할 수 있도록 도와주는 데코레이터
  // 이 객체를 사용하여 츨략힌 내용은 모두 위의 StringWriter에 보관된다.
